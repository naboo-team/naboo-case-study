...
export type Query = {
  ...
  getUserFavorites: Array<FavoriteDto>;
...
export type ActivityFragment = {
  ...
  name: string;
  price: number;
  owner: { __typename?: "UserDto"; firstName: string; lastName: string };
};
...
export type SignupMutation = {
  ...
  register: {
    ...
    firstName: string;
    lastName: string;
    role: { __typename?: "RoleDto"; name: string };
  };
};
...
export type ResolversTypes = {
  ...
  FavoriteDto: ResolverTypeWrapper<FavoriteDto>;
...
export type ActivityDtoResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ActivityDto"] = ResolversParentTypes["ActivityDto"]
> = {
...
> = {
  getActivities?: Resolver<
    Array<ResolversTypes["ActivityDto"]>,
    ParentType,
    ContextType
  >;
  ...
  getActivitiesByUser?: Resolver<
    ...
    ContextType
  >;
  getUserFavorites?: Resolver<
    Array<ResolversTypes["FavoriteDto"]>,
    ParentType,
    ContextType
  >;
